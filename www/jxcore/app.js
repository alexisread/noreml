...
// AJR the below is pasted from ./node_modules/node-red/red.js - entry point for node-red
// We need to use the es5 version of jsonata
// We need to use ./node_modules/node-red/node_modules/mqtt/dist/mqtt.js over the mqtt.min.js version as the precompiled version has class decs in
require('es5-shim');
require('es6-shim');
...
// AJR We put the settings file next to app.js
...
RED.start().then(function() {
    if (settings.httpAdminRoot !== false || settings.httpNodeRoot !== false || settings.httpStatic) {
        ...
        server.listen(settings.uiPort,settings.uiHost,function() {
			...
			// Send listen to web frontend
			clog("Express server is started. (port: " + settings.uiPort + ")");
        });
    } else {
